...
function Library:_setMinimized(minimized: boolean)
	...
	if minimized then
		...
		brandMark.Position = UDim2.new(0.5, -58, 0.5, 0)
		brand.AnchorPoint = Vector2.new(0, 0.5)
		brand.Position = UDim2.new(0.5, -34, 0.5, 0)
		brand.Size = UDim2.fromOffset(150, 36)
		...
		brandMark.AnchorPoint = Vector2.new(0, 0)
		brandMark.Position = UDim2.fromOffset(0, 0)
